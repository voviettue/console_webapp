...
const theme = {
	...
	textarea: {
		...textClassification,
		input:
			'block w-full h-24 px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm',
	},
